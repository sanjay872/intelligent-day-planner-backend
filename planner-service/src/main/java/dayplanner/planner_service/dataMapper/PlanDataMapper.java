...
public interface PlanDataMapper {
    ...
    @Mapping(target = "plannedDate",source = "plannedDate",qualifiedByName = "convertStringToDate")
    ...
    @Mapping(target = "plannedDate",source = "plannedDate",qualifiedByName = "convertDateToString")
